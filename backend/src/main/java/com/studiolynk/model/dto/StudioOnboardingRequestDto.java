...
/**
 * Request payload for Studio Onboarding (STU-001, STU-002).
 */
public class StudioOnboardingRequestDto {
    ...
    // STU-002 Identity verification document / declaration
    private String documentType;
    private String documentUrl;
    private String declarationText;

    public StudioOnboardingRequestDto() {
    }
